...
module.exports = (sequelize) => {
  const Match = sequelize.define('Match', {
    ...
    validate: {
      teamsNotSame() {
        if (this.homeTeamId && this.awayTeamId && this.homeTeamId === this.awayTeamId) {
  ...
  Match.associate = (models) => {
    Match.belongsTo(models.Tournament, { foreignKey: 'tournamentId', as: 'tournament' });
    ...
    Match.hasMany(models.PlayerMatchStats, { foreignKey: 'matchId', as: 'playerStats' });
  };
